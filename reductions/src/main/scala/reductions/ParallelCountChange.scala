...
object ParallelCountChange {
  ...
  def moneyThreshold(startingMoney: Int): Threshold = (money, coins) => money <= (2.0 / 3.0 * startingMoney)

  /** Threshold heuristic based on the total number of initial coins. */
  def totalCoinsThreshold(totalCoins: Int): Threshold = (money, coins) => coins.length <= (2.0 / 3.0 * totalCoins)
